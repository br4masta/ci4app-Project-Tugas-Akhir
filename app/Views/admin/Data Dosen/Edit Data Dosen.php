        ...
        <div class="col">
            <form role="form" class="form-horizontal" enctype="multipart/form-data" action="" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input name="nama" class="form-control" id="nama" type="text" value="sucipto" />
                        <span></span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input name="username" class="form-control" id="username" type="text" value="sucipto" />
                        <span></span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input name="password" id="pass" class="form-control" type="akusucipto" value="e172dd95f4feb21412a692e73929961e" />
                        <span></span>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input name="userfile" id="userfile" type="file" class="form-control" />anonim.png
                    </div>
                </div>
                <div class="form-group">
