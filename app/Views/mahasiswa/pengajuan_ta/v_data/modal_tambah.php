<div class="modal fade" id="modaltambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <?= form_open_multipart('mahasiswa/simpandatapengajuanta', ['class' => 'formmahasiswa']) ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                ...
                <div class="form-group row">
                    <label for="" class="col-sm-2 col-form-label">Upload File proposal Tugas Akhir</label>
                    <div class="col-sm-6">
        ...
        $(document).ready(function() {
            $(".btnsimpan").click(function(e) {
                ...
                $.ajax({
                    ...
                    contentType: false,
                    cache: false,
                    url: "<?= site_url('mahasiswa/simpandatapengajuanta'); ?>",
                    data: data,
                    dataType: "json",
                    beforeSend: function() {
