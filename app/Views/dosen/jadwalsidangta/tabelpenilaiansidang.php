                    ...
                    <?php foreach ($sidangta as $d) : ?>
                        <div class="card-body box-profile">
                            ...
                            <div class="mt-5" style=" text-align : center; vertical-align: middle;">
                                <a href="<?= base_url(); ?>/assets/img/file/<?= $d['berkas_proposal_ta']; ?>"> <button type="button" class="btn btn-outline-primary btn-sm">View File</button> </a>
                            </div>
                        <?php endforeach; ?>
                        </div>
                        <!-- /.card-body -->
                        ...
                        <div class="tab-content">
                            <div class="active tab-pane" id="settings">
                                ...
                                <?php foreach ($sidangta as $a) : ?>
                                    <form action="/dosen/updatesidangta/<?= $a['id_sidangta']; ?>" method="POST">
                                        <?= csrf_field(); ?>
                                            ...
                                            <tbody>
                                                ...
                                                <?php if ($status_dospem == 'dosen pembimbing I') : ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-group mb-3">
                                                                <input type="text" class="form-control" name="nilai" id="nilai" value="<?= $a['nilai_pembimbing_1_ta']; ?>">
                                                            </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-group mb-3">
                                                                <textarea class="form-control" id="catatan" name="catatan" rows="3"><?= $a['catatan_pembimbing_1_ta']; ?></textarea>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                ...
                                                <?php elseif ($status_dospem == 'dosen pembimbing II') : ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-group mb-3">
                                                                <input type="text" class="form-control" name="nilai" id="nilai" value="<?= $a['nilai_pembimbing_2_ta']; ?>">
                                                            </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-group mb-3">
                                                                <textarea class="form-control" id="catatan" name="catatan" rows="3"><?= $a['catatan_pembimbing_2_ta']; ?></textarea>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                <?php endif; ?>
