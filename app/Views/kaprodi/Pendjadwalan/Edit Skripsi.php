            ...
            <div class="card">
                <div class="form-group">
                    <!-- Start: Bootstrap Form Basic --><?php foreach ($data1 as $d) : ?>
                        <form class="bootstrap-form-with-validation mx-5" action="/kaprodi/updatejadwalskripsi/<?= $d['id_jadwal_ta']; ?>" method="POST">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-8">
                                    ...
                                    <a href="<?= site_url('kaprodi/skripsiterjadwal'); ?>" class="btn btn-warning btn-square ">Kembali</a>
                                </div>
                            </div>
