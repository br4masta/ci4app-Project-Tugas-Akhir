                ...
                <?php foreach ($berita as $d) : ?>
                    <form class="bootstrap-form-with-validation mx-5">
                        ...
                        <div class="row mb-3 mt-3">
                            ...
                            <div class="col-sm-10">
                                <input type="email" class="form-control" id="inputEmail3" value="<?= $d['acara_sidang_ta']; ?>" readonly>
                            </div>
                        </div>
                        <!--  -->
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="email" class="form-control" id="inputEmail3" value="<?= $d['tanggal_sidang_ta']; ?>" readonly>
                            </div>
                        </div>
                        <!-- <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="email" class="form-control" id="inputEmail3" value="<?= $d['tempat_sidang_ta']; ?>" readonly>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="inputEmail3" class="col-sm-2 col-form-label">Nilai Akhir</label>
                            <div class="col-sm-10">
                                <input type="email" class="form-control" id="inputEmail3" value="<?php $tot = $d['nilai_penguji_1_ta'] + $d['nilai_penguji_2_ta'] + $d['nilai_pembimbing_1_ta'] + $d['nilai_pembimbing_2_ta'];
                                                                                                    $rata = $tot / 4;
                                                                                                    echo $rata; ?>" readonly>
                            </div>
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div id="pdfDownloadLinkContainer" class="mb-5">
                            <a class="action pdf" id="pdfDownloadLink" target="_parent" href="<?= base_url() ?>/assets/admin/berkas/<?= $d['berkas_proposal_ta']; ?>">Download this PDF file</a>
                        </div>
                    ...
                    <div class="card-body ">
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $d['nilai_penguji_1_ta']; ?></td>
                                    <td><?= $d['catatan_penguji_1_ta']; ?></td>
                                ...
                                <tr>
                                    ...
                                    <td><?= $d['nilai_penguji_2_ta']; ?></td>
                                    <td><?= $d['catatan_penguji_2_ta']; ?></td>
                                ...
                                <tr>
                                    ...
                                    <td><?= $d['nilai_pembimbing_1_ta']; ?></td>
                                    <td><?= $d['catatan_pembimbing_1_ta']; ?></td>
                                ...
                                <tr>
                                    ...
                                    <td><?= $d['nilai_pembimbing_2_ta']; ?></td>
                                    <td><?= $d['catatan_pembimbing_2_ta']; ?></td>
                        ...
                        <a href="<?= site_url('kaprodi/beritaskripsi'); ?>" class="btn btn-warning btn-square mb-5">Kembali</a>
                    </div><?php endforeach; ?>
