    ...
    <div class="row">
        <div class="col">
            ...
            <?php foreach ($datadosen as $d) : ?>
                <form action="/DosenPenguji/updatedatadosen/<?= $d['id_dosen']; ?>" method="POST" enctype="multipart/form-data"><?= csrf_field(); ?>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-8">
                            ...
                            <a href="<?= site_url('dosen/index'); ?>" class="btn btn-warning btn-square">Kembali</a>
                        </div>
                    </div>
                </form>
            <?php endforeach; ?>
