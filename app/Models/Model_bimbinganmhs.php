    ...
    public function get_idbimbingan($data1)
    {
        return $this->table_bimbingan2
            ...
            ->select([
                ...
                'bimbingan.id_bimbingan as id_bimbingan',
                'bimbingan.judul_bimbingan as judul_mhs',
                'bimbingan.catatan_bimbingan_pembimbing1 as catatan_mhs_1',
                'bimbingan.catatan_bimbingan_pembimbing2 as catatan_mhs_2',
                'bimbingan.status_bimbingan_pembimbing1 as status_mhs_1',
                'bimbingan.status_bimbingan_pembimbing2 as status_mhs_2',
                'bimbingan.berkas_bimbingan as berkas_mhs',
                'bimbingan.tanggal_bimbingan as tanggal_mhs',
                'user.id_user',
            ])
